        ...
        {(scholarships || []).map((sch) => (
          <div key={sch._id} className="card bg-blue-100 shadow-xl p-4">
            ...
            <div className="card-body">
              ...
              <p><strong className="text-pink-500">Category:</strong> {sch.scholarshipCategory}</p>
              <p><strong className="text-pink-500">Location:</strong> {sch.universityCountry}</p>
              <p><strong className="text-pink-500">Application Fee:</strong> ${sch.applicationFees}</p>
